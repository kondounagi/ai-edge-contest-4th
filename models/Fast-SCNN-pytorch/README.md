...
```
CUDA_VISIBLE_DEVICES=0 python train.py --resize 1024 --base-size 512 --crop-size 384 --batch-size 48 --lr 0.04 --weight-decay 0.0004 --train_img_dir city4sig_pretrain/img --train_mask_dir city4sig_pretrain/gt
```
### finetune with signate dataset
```
CUDA_VISIBLE_DEVICES=0 python train.py --resize 1024 --base-size 512 --crop-size 384 --batch-size 48 --lr 0.04 --weight-decay 0.0004 --train_img_dir seg_train_images --train_mask_dir seg_train_annotations
```
### evaluation and runtime measurement 
```
CUDA_VISIBLE_DEVICES=0 kernprof -l eval.py --resize 1024 --base-size 512 --crop-size 384 --sub_out_dir 1024 --model_path fast_scnn_1024best_model.pth
